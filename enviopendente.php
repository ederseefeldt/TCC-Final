    ...
    <section class="section-pedidos">
        <div class="display">
            <div class="header-pedidos">
                ...
                <a style="height: 10vh; background-color: #0066db;" href="enviopendente.php">Envio Pendente</a>
            ...
            <div class="body-pedidos">
                ...
                if(isset($_POST["btn_buscar_cliente"])) {
                    ...
                    if(!empty($busca)) {
                        ...
                        WHERE P.pedido_id LIKE '%$busca%' OR C.cliente_nome LIKE '%$busca%' AND pedido_usuario_id = '$id_logado' AND P.pedido_status = 0 GROUP BY P.pedido_id";
                        ...
                        while ($registro = mysqli_fetch_array($resultado)) {
                            ...
                            <div class='pedido'>
                                ...
                                <div style='width: 9vw; display: flex; align-items: center;'>
                                    <span style='background-color: #fd6b6b;' class='pedido-status'>Não Enviado</span>
                                </div>
                                <div class='btns-pedidos-a-finalizar'>
                                    ...
                                    <form action='code.php' method='POST'>
                                        ...
                                        <button style='background-color: #0066db;' name='btn_enviar_pedido' value=".$pedido_id.">Enviar</button>
                        ...
                        $sql = "SELECT pedido_id, cliente_nome, pedido_data, SUM(pd_quantidade * produto_valor) AS 'valor_total' FROM pedido P INNER JOIN cliente C ON P.pedido_cliente_id = C.cliente_id 
                        INNER JOIN pedido_produtos PD ON P.pedido_id = PD.pd_pedido_id INNER JOIN produto PR ON PR.produto_id = PD.pd_produto_id WHERE pedido_usuario_id = '$id_logado' AND P.pedido_status = 0 GROUP BY P.pedido_id";
                        $resultado = mysqli_query($conectar, $sql);
